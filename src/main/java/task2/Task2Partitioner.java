...
public class Task2Partitioner extends Partitioner<Text, IntWritable> {
	
	final private static Logger Task1PartitionerLogger = Logger.getLogger(Task2Partitioner.class);
