...
public class Task3Partitioner extends Partitioner<Text, IntWritable> {
	
	final private static Logger Task1PartitionerLogger = Logger.getLogger(Task3Partitioner.class);
